// COPY-PASTED HERE FROM https://raw.github.com/mongodb/casbah/master/casbah-commons/src/test/scala/test/Specs2Helpers.scala
// because Specs2Helper.scala has been relocated to an unpublished test jar
// Expected to be fixed with 2.6.1 release per https://groups.google.com/forum/?fromgroups=#!topic/mongodb-casbah-users/uSM5khY56l4
