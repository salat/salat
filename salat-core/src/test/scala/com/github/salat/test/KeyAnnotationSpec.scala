...
class KeyAnnotationSpec extends SalatSpec {
  ...
  "The @Key annotation" should {
    ...
    "work with a field whose type is handled by a custom BSON encoding hook" in {
      com.github.salat.test.util.RegisterURIConversionHelpers()
      ...
      dbo must havePair("_typeHint" -> "com.github.salat.test.model.Page")
      ...
      com.github.salat.test.util.DeregisterURIConversionHelpers()
