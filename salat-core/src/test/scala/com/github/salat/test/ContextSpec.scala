...
class ContextSpec extends SalatSpec {
  ...
  val caseObjectClazz = Class.forName("com.github.salat.test.model.Zoot$")
  val annotatedAbstractClazz = Class.forName("com.github.salat.test.model.AbstractMaud")
  val abstractClazz = Class.forName("com.github.salat.test.model.UnannotatedAbstractMaud")
  val annotatedTraitClazz = Class.forName("com.github.salat.test.model.AnnotatedMaud")
  val traitClazz = Class.forName("com.github.salat.test.model.UnannotatedMaud")
  ...
  "Using the context to lookup graters" should {
    ...
    "provide a lookup method that lazily generates and returns graters" in {
      ...
      "by class name for a case object" in new testContext {
        ...
        // TODO: can't get type for com.github.salat.test.model.Zoot$
  ...
  "The context" should {
    "support suppressing default args" in {
      import com.github.salat.test.model.sda._
      import com.github.salat.test.model.suppress_default_args._
