...
//
//      // members of com.github.salat.test.model can be resolved as expected
...
//      val TestClassName = "com.github.salat.test.CustomContextSpec$$anonfun$1$$anonfun$apply$15$$anon$2$Ida"
//
...
//
//      // a context where com.github.salat.test.model.Rhoda has a key remapping
//      import com.github.salat.test.per_class_key_remapping._
//
//      ctx.perClassKeyOverrides must haveKey(("com.github.salat.test.model.Rhoda", "consumed"))
//      ctx.perClassKeyOverrides.get(("com.github.salat.test.model.Rhoda", "consumed")) must beSome("fire")
//
...
//      dbo2 must havePair("_typeHint", "com.github.salat.test.model.Rhoda3")
