...
class MongoJavaDriver252IntLongBugSpec extends SalatSpec {
  "mongo-java-driver 2.5.2" should {
    "not be confused about the difference between Int and Long when parsing from stringified JSON" in {
      ...
      //[error]
      //[error]   Grater(class com.github.salat.test.model.Company @ com.github.salat.global.package$$anon$1@222380e2) toObject failed on:
      //[error]   SYM: com.github.salat.test.model.Company
      //[error]   CONSTRUCTOR: public com.github.salat.test.model.Company(java.lang.String,int,scala.collection.immutable.Map)
      //[error]   ARGS:
