...
abstract class SalatDAO[ObjectType <: AnyRef, ID <: Any](val collection: MongoCollection)(implicit
  mot: Manifest[ObjectType],
    ...
    extends com.github.salat.dao.DAO[ObjectType, ID] with Logging {

  dao =>

  /** Supplies the [[com.github.salat.Grater]] from the implicit [[com.github.salat.Context]] and `ObjectType` manifest */
