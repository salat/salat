...
import com.github.salat.transformers.in.{MapInjector, OptionInjector, TraversableInjector}
import com.github.salat.transformers.out.{MapExtractor, OptionExtractor, TraversableExtractor}
